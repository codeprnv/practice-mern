...
const Login = () => {
  ...
  return (
    <div className="flex h-screen w-screen min-w-[320px] items-center justify-center overflow-hidden bg-blue-800">
      <div className="mx-[1.5em] mt-10 flex h-auto w-full max-w-3xl flex-col overflow-hidden rounded-xl bg-white shadow-lg lg:flex-row">
        ...
        <div className="w-full p-6 sm:p-10 lg:w-1/2">
          <form className="flex w-full flex-col gap-5" onSubmit={handleSubmit}>
            <h2 className="mb-4 text-2xl font-bold text-green-600">Log In</h2>
